                    ...
                    <div class="card-body " id="bar-parent">
                        <table id="exportTable" class="display nowrap" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$tsk->id}}</td>
                                    <td><a class="parent-item" href="{{route('task.show',[$tsk->id])}}"> {{$tsk->title}}
                                        </a></td>
                                    ...
                                    <td class="valigntop">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-left" role="menu">
                                                <li>
                                                    <a href="javascript:;">
                                                        <form action="{{route('pending',$tsk->id)}}" method="post">
                                                            {{csrf_field()}}
                                                            <input type="hidden" name="_method" value="PUT">
                                                            <button class="btn " type="submit"><span class=""></span>
                                                                Pending
                                                            </button>
                                                        </form>
                                                    </a>
