                ...
                <div class="col-md-12 col-sm-12">
                    <div class="card card-box">
                        ...
                        <div class="card-body" id="bar-parent2">
                            <form action="{{route('task.update',$tasks->id)}}" method="post" id="form_sample_2" class="form-horizontal" 
                                ...
                                <div class="form-body">
                                    <div class="form-group row  margin-top-20">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <input type="text" class="form-control" required name="title" value="{{old('title',$tasks->title)}}"/></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row  margin-top-20">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <textarea name="description" class="form-control textarea" required rows="10">{{old('description',$tasks->description)}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row  margin-top-20">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-icon right ">
												...
												<option value="{{ $tasks->assignedTo }}" selected>{{ $tasks->employee['name'] }}</option>
                                ...
                                <div>
                                    <div class="form-group row margin-top-20">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-append date form_date" data-date-format="yy-m-d H:i:s">
                                                <input size="65" type="text" required readonly name="deadline" value="{{old('deadline',$tasks->deadline)}}">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-icon right ">
                                                ...
                                                <select class="form-control input-height" required name="task_priority">
													<option value="{{ $tasks->task_priority }}" selected>{{ $tasks->task_priority }}</option>
                                                    <option value="" disabled class="bg-dark">--Select Priority--</option>
									...
									<div class="form-group row margin-top-20">
                                        	<label class="control-label col-md-3">Attached File
                                       		...
                                       		<div class="col-md-8">
                                            	<div class="input-icon right">
                                                	<input type="file" class="form-control bg-light" name="fileUpload" value="{{old('fileUpload',$tasks->fileUpload)}}"/></div>
                                        		</div>
                                    		</div>
									</div>
                                    ...
                                    <div class="form-group row  margin-top-20">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-icon right">
                                                ...
                                                required rows="10">{{old('remarks',$tasks->remarks)}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    {{--User Id--}}
