            ...
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                            href="{{route('admin-dashboard')}}">Dashboard</a>&nbsp;<i class="fa fa-angle-right"></i>
                    </li>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="inst_name" value="{{old('inst_name','')}}" />
                                                        @error('inst_name')
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <input type="text"
                                                            class="form-control @error('inst_address') is-invalid @enderror"
                                                            name="inst_address" value="{{old('inst_address','')}}" />
                                                        @error('inst_address')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        <div class="input-height date form_date"
                                                            ...
                                                            <input class="@error('passed_year') is-invalid @enderror"
                                                                size="30" type="text" required readonly
                                                                name="passed_year" value="{{old('passed_year','')}}"
                                                                aria-required="true">
                                                            @error('passed_year')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{$message}}</strong>
                                            ...
                                            <div class="form-group row  margin-top-20">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        ...
                                                        <input type="text"
                                                            class="form-control @error('inst_name') is-invalid @enderror"
                                                            name="inst_name" value="{{$educ->inst_name}}" />
                                                        @error('inst_name')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                                    ...
                                                    <div class="input-icon right">
                                                        <div class="input-height date form_date"
                                                            ...
                                                            <input size="30" type="text" required readonly
                                                                class="@error('passed_year') is-invalid @enderror"
                                                                name="passed_year" aria-required="true"
                                                                value="{{$educ->passed_year}}">
                                                            @error('passed_year')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{$message}}</strong>
                                                            </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <textarea name="about"
                                                            class="form-control textarea  @error('about') is-invalid @enderror"
                                                            required rows="10">{{old('about','')}}</textarea>
                                                        @error('about')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <input type="file"
                                                            class="form-control @error('ctzn_f') is-invalid @enderror"
                                                            name="ctzn_f" value="{{old('ctzn_f','')}}" />
                                                        @error('ctzn_f')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <input type="file"
                                                            class="form-control @error('ctzn_b') is-invalid @enderror"
                                                            name="ctzn_b" value="{{old('ctzn_b','')}}" />
                                                        @error('ctzn_b')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        ...
                                                        <textarea name="about"
                                                            class="form-control textarea @error('about') is-invalid @enderror"
                                                            required rows="10">{{old('about',$prsnl->about)}}</textarea>
                                                        @error('about')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        ...
                                                        <input type="text"
                                                            class="form-control @error('address1') is-invalid @enderror"
                                                            name="address1" value="{{$prsnl->address1}}" />
                                                        @error('address1')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        ...
                                                        <input type="text"
                                                            class="form-control @error('address2') is-invalid @enderror"
                                                            name="address2" value="{{$prsnl->address2}}" />
                                                        @error('address2')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        ...
                                                        <input type="text"
                                                            class="form-control @error('phone1') is-invalid @enderror"
                                                            name="phone1" value="{{$prsnl->phone1}}" />
                                                        @error('phone1')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        ...
                                                        <input type="text"
                                                            class="form-control @error('phone2') is-invalid @enderror"
                                                            name="phone2" value="{{$prsnl->phone2}}" />
                                                        @error('phone2')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        <div class="input-append date form_date"
                                                            ...
                                                            <input size="30" type="text" required="" readonly
                                                                class=" @error('dob') is-invalid @enderror" name="dob"
                                                                aria-required="true" value="{{$prsnl->dob}}">
                                                            @error('dob')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{$message}}</strong>
                                                            </span>
                            ...
                            <div class="tab-pane" id="work">
                                <div class="card-body" id="bar-parent2">
                                    @if($wrk == [])
                                    <form action="{{route('work.store')}}" id="form_sample_2" class="form-horizontal"
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        ...
                                                        <textarea name="experience"
                                                            class="form-control textarea @error('experience') is-invalid @enderror"
                                                            required rows="10">{{old('experience','')}}</textarea>
                                                        @error('experience')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        ...
                                                        <textarea name="skills"
                                                            class="form-control textarea @error('skills') is-invalid @enderror"
                                                            required rows="10">{{old('skills','')}}</textarea>
                                                        @error('skills')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        ...
                                                        <textarea name="projects"
                                                            class="form-control textarea @error('projects') is-invalid @enderror"
                                                            required rows="10">{{old('projects','')}}</textarea>
                                                        @error('projects')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group">
                                                <div class="offset-md-3 col-md-9">
                                                    ...
                                                    <a class="btn btn-default"
                                                        href="{{route('user_profile')}}">Cancel</a>
                                                </div>
                                            </div>
                                    </form>
                                    @endif
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        ...
                                                        <textarea name="experience"
                                                            class="form-control textarea @error('experience') is-invalid @enderror"
                                                            required
                                                            rows="10">{{old('experience',$wrk->experience)}}</textarea>
                                                        @error('experience')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        ...
                                                        <textarea name="skills"
                                                            class="form-control textarea @error('skills') is-invalid @enderror"
                                                            required rows="10">{{old('skills',$wrk->skills)}}</textarea>
                                                        @error('skills')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon right">
                                                        ...
                                                        <textarea name="projects"
                                                            class="form-control textarea @error('projects') is-invalid @enderror"
                                                            required
                                                            rows="10">{{old('projects',$wrk->projects)}}</textarea>
                                                        @error('projects')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{$message}}</strong>
                                                        </span>
                        ...
                        <div class="tab-pane" id="settings">
                            <div class="card-body" id="bar-parent2">
                                <form action="{{route('update_password')}}" id="form_sample_2" class="form-horizontal"
