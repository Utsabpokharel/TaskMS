                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="password" name="password" required
                                            ...
                                            class="form-control input-height @error('password') is-invalid @enderror"
                                            value="{{old('password','')}}" />
                                        @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="password" name="password_confirmation" required
                                            ...
                                            class="form-control input-height @error('password_confirmation') is-invalid @enderror"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-append date form_date col-md-5 @error('joined_date') is-invalid @enderror"
                                        ...
                                        <input class="@error('joined_date') is-invalid @enderror" size="40" type="text"
                                            readonly name="joined_date" value="{{old('joined_date','')}}">
