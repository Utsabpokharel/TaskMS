            ...
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="card-body" id="bar-parent">
                        <form action="{{route('user.update',$users->id)}}" id="form_sample_1" class="form-horizontal"
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="emp_id" required placeholder="Enter Employee ID"
                                            class="form-control input-height @error('emp_id') is-invalid @enderror"
                                            value="{{old('emp_id',$users->emp_id)}}" />
                                        @error('emp_id')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="email" name="email" required placeholder="enter User email"
                                            class="form-control input-height @error('email') is-invalid @enderror"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <select class="form-control input-height @error('role_id') is-invalid @enderror"
                                            name="role_id">
                                            <option value="{{ $users->role_id }}" selected>{{ $users->roles['name'] }}
                                            </option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" name="position" required
                                            ...
                                            class="form-control input-height @error('position') is-invalid @enderror"
                                            value="{{old('position',$users->position)}}" />
                                        @error('position')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <select
                                            class="form-control input-height @error('department_id') is-invalid @enderror"
                                            name="department_id">
                                            <option value="{{ $users->department_id }}" selected>
                                                {{ $users->department['main_dept'] }}</option>
                                            <option value="" class="bg-dark" disabled>---Select Main-Department---
                                            </option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <select
                                            class="form-control input-height @error('sub_department') is-invalid @enderror"
                                            name="sub_department">
                                            <option value="{{ $users->department_id }}" selected>
                                                {{ $users->department['sub_dept'] }}</option>
                                            <option value="" class="bg-dark" disabled>---Select Sub-Department---
                                            </option>
                                            @foreach($depart as $dept)
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-append date form_date col-md-5 @error('joined_date') is-invalid @enderror"
                                        data-date-format="yyyy-mm-dd" data-date="2013-02-21T15:25:00Z">
                                        <input size="40" type="date" name="joined_date"
                                            value="{{old('joined_date',$users->joined_date)}}">
