        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li><a class="parent-item" href="{{ route('leaveType.index')}}">Apply Leave</a>&nbsp;<i
                            class="fa fa-angle-right"></i>
                    </li>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    ...
                    <div class="card-body" id="bar-parent">
                        <form action="{{ route('leave.store')}}" id="form_sample_1" class="form-horizontal"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="input-append date form_date col-md-5" data-date-format="yyyy-mm-dd">
                                        <input class="@error('from') is-invalid @enderror" size="40" type="text"
                                            required readonly name="from" value="{{old('from','')}}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        <textarea name="leave_reason" required placeholder="Enter Leave Reason"
                                            ...
                                            rows="5">{{old('leave_reason','')}}</textarea>
                                        @error('leave_reason')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{$message}}</strong>
                                        </span>
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="offset-md-3 col-md-9">
                                        <button type="submit" class="btn btn-info m-r-20">Apply</button>
