						...
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								...
								<div class="card-body" id="bar-parent">
									<form action="{{route('department.update',$depart->id)}}" id="form_sample_1" class="form-horizontal" method="post" autocomplete="on">
										{{csrf_field()}}
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<textarea name="description" required placeholder="enter department details"
														class="form-control textarea input-height @error('description') is-invalid @enderror" rows="5">{{old('main_dept',$depart->description)}}</textarea>
														@error('description')
															<span class="invalid-feedback" role="alert">
																<strong>{{$message}}</strong>
															</span>
