...
{
    protected $fillable = [
        'title', 'description', 'assignedDate', 'completedDate', 'assignedTo', 'deadline', 'reason',
        'task_priority', 'fileUpload', 'assignedBy', 'ReAssignedBy', 'reAssignedTo', 'reAssignedDate', 'reDeadline', 'status', 'remarks', 'user_id', 'ReUser_id'
    ];
    ...
    {
        return $this->belongsTo('App\allUser', 'ReUser_id');
    }
